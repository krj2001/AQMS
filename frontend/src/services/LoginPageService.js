...
export const AppVersionDeleteService = (id, successCallback, errorCallBack) => _fetchService(`appVersion/${id}/delete`, 'DELETE', {}, successCallback, errorCallBack);
...
export const SearchDeviceDataService = (data, successCallback, errorCallBack) => _fetchService('searchDeviceData', 'POST', data, successCallback, errorCallBack);
...
export const NavigateAlarmService = (data, successCallback, errorCallBack) =>_fetchService('navigateAlarm', 'POST', data, successCallback, errorCallBack);


//--------hooterStatus------//

export const HooterStatusService = (data, successCallback, errorCallBack) =>_fetchService('hooterStatus', 'POST', data, successCallback, errorCallBack);
