...
class AppDataUtilityController extends Controller
{
    ...
    function __construct($request,$query) {
        if($query) {
            ...
            // $this->result = $query->offset(value:($this->page ) * $this->perPage)->limit($this->perPage);    //data will be stored in  results
