...
CREATE TABLE `Aqi_values_per_deviceSensor` (
  ...
  `sampled_date_time` varchar(225) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9498 DEFAULT CHARSET=latin1;
...
CREATE TABLE `aidealab_companies` (
  ...
  `lastPeriodicBackupDate` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
("1","Ai-DEA Labs Pvt. Ltd","jananes@aidealabs.com","2","2023-01-05 10:58:10","95","2022-10-13 11:53:58","2022-10-13 11:53:58");
...
("1","2022-09-29","09:21:01","A-TEST","3","52","NH3_gas1","outOfRange","1535.5","OUT OF RANGE VALUE IS HIGH","HIGH","0","NotCleared","","Latch","Out Of Range","","","","","2022-09-29 03:51:01"),
("2","2022-09-29","09:21:01","A-TEST","3","51","SO2_gas1","outOfRange","-48.5","OUT OF RANGE VALUE IS LOW","NORMAL","1","Cleared","Values are Normal","UnLatch","Out Of Range","","","","","2022-09-29 03:51:01");
...
CREATE TABLE `aqmi_json_data` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=455735 DEFAULT CHARSET=latin1;


INSERT INTO aqmi_json_data VALUES
("454735","2023-01-06 14:56:04","{\"DATE\":\"2023-01-06\",\"TIME\":\"14:56:04\",\"COMPANY\":\"Cust12\",\"LOCATION\":\"52\",\"BRANCH\":\"56\",\"FACILITY\":\"45\",\"BULDING\":\"55\",\"FLOOR\":\"47\",\"LAB\":\"50\",\"DEVICE_ID\":\"120\",\"SD_CARD\":\"1\",\"RSSI\":\"28\",\"MODE\":\"2\",\"ACCESS_CODE\":\"1003\",\"AQMi_O2\":\"2.7\",\"AQMi_CO\":\"2.5\"}","2023-01-06 09:26:04",""),
("454736","2023-01-06 14:56:06","{\"DATE\":\"2023-01-06\",\"TIME\":\"14:56:06\",\"COMPANY\":\"Cust12\",\"LOCATION\":\"52\",\"BRANCH\":\"56\",\"FACILITY\":\"45\",\"BULDING\":\"55\",\"FLOOR\":\"47\",\"LAB\":\"50\",\"DEVICE_ID\":\"120\",\"SD_CARD\":\"1\",\"RSSI\":\"28\",\"MODE\":\"2\",\"ACCESS_CODE\":\"1003\",\"AQMi_O2\":\"2.7\",\"AQMi_CO\":\"2.5\"}","2023-01-06 09:26:06","");
...
CREATE TABLE `bumpTest_aqmi_json_data` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13677 DEFAULT CHARSET=latin1;
...
("1","A-Tech Solutions","abhishekshenoy7@gmail.com","8660839819","Mangalore","A-TEST","Customers/A-TEST/logo/customerLogo.png","","2022-03-31 21:20:53","2023-01-03 15:12:03","10","10","5","15","15","3"),
...
CREATE TABLE `devices` (
  ...
  `initialConnect` tinyint(1) NOT NULL DEFAULT '0',
  `modeChangedDateTime` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
("1","PR-TEST","1","2","1","1","1","","1","AQMI010","1","AQMI","qw123","01.01.01.90","AQ918919","","20:59","08:58","http://varmatrix.com/Aqms/blog/public/Customers/PR-TEST/Buildings/devices/ConfigSettingFile/AQMI010_DataPush.json","http://varmatrix.com/Aqms/blog/public/Customers/PR-TEST/Buildings/devices/ConfigSettingFile","","","enabled","0","0","","1","0","0","0","2","","0","","2022-03-31 23:57:03","2022-03-31 23:57:03"),
("2","PR-TEST","1","2","1","1","1","","1","AQMO0725","1","AQMI","787878","24:D7:EB:87:19:1D","AQo001","","03:59","22:43","http://varmatrix.com/Aqms/blog/public/Customers/PR-TEST/Buildings/devices/ConfigSettingFile/AQMO0725_DataPush.json","http://varmatrix.com/Aqms/blog/public/Customers/PR-TEST/Buildings/devices/ConfigSettingFile","","Customers/PR-TEST/Buildings/devices/AQMO0725.png","enabled","0","1","","1","0","0","0","1","","0","","2022-04-01 00:00:49","2022-09-19 16:23:01");
...
CREATE TABLE `personal_access_tokens` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15816 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sampled_sensor_data_details_MinMaxAvg` (
  ...
  `param_unit` varchar(200) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=271320 DEFAULT CHARSET=latin1;
...
CREATE TABLE `segregatedValues` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1657476 DEFAULT CHARSET=latin1;


INSERT INTO segregatedValues VALUES
("1656476","3","PM10_GAS2","2","1003","-0.00","-444.5","2023-01-06 16:19:01","2023-1-6 16:23:40","2023-01-06 10:49:01"),
("1656477","3","Tester anaolg","2","1003","-0.00","-444.5","2023-01-06 16:21:02","2023-1-6 16:25:41","2023-01-06 10:51:02");
...
CREATE TABLE `user_logs` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17008 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
("4","Ai-DEA Labs Pvt. Ltd","jananes@aidealabs.com","9449026060","0000","Ai-DEA Labs Pvt. Ltd","","","","","","","superAdmin","0","0","9471","2022-04-18 21:26:32","0","0","0","","$2y$10$IyUWe7MX9BMfz/7pp5XChezT1rRJlfcVWl9VXwPXQcxm75oNgv.ie","","SuperAdmin/logo/Janane_Logo.png","1","2022-03-31 20:13:04","2023-01-07 09:36:04","2023-01-07 09:36:04"),
("5","Abhishek","abhishekshenoy7@gmail.com","8660839819","00000","A-TEST","","","","","","","systemSpecialist","0","0","7231","2022-11-19 12:34:36","1","0","0","","$2y$10$5D7HJuAOmIROyMpW4Ef/Cu3j3123zkCrDMYE8ikdEoi18QdTysQ2.","","","1","2022-03-31 21:20:55","2023-01-07 10:40:30","2023-01-07 10:40:30");
