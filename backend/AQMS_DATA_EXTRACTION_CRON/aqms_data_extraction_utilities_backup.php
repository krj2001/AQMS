...
function alertMessage($conn,$companyCode,$deviceId,$parameterTag,$upload_date,$upload_time,$val){
    ...
    if($isStel == 1){
        ...
        if(intval($val)>$stelLimit){
            ...
            InsertAlertCronData($conn,$a_date,$a_time,$companyCode,$deviceId,$sensorId,$sensorTag,$alertTypes,$val,$Message,$severity,$status,$statusMessage,$alarmType,$current_time,$sensorStatus,$notificationStatus,$hooterRelayStatus);           
    ...
    //updating unlatch to 1 and setting to clear if thresholds meets 
        if($alarmType == "UnLatch"){ //COMMENTED FOR TIME BEING IF ONLY LATCHED ALARM UPDATE
            ...
            if($criticalAlertStatusFlag === 1){
                ...
                $status = $alertStatus[1];
                $statusMessage = $alertStatusMessage[1];
                InsertAlertCronData($conn,$a_date,$a_time,$companyCode,$deviceId,$sensorId,$sensorTag,$alertTypes,$val,$criticalMessage,$severity,$status,$statusMessage,$alarmType,$current_time,$sensorStatus,$notificationStatus,$hooterRelayStatus);
            ...
            if($outOfRangeAlertStatusFlag === 1){
                ...
                $status = $alertStatus[1];
                $statusMessage = $alertStatusMessage[1];
                InsertAlertCronData($conn,$a_date,$a_time,$companyCode,$deviceId,$sensorId,$sensorTag,$alertTypes,$val,$outofrangeMessage,$severity,$status,$statusMessage,$alarmType,$current_time,$sensorStatus,$notificationStatus,$hooterRelayStatus);           
            }
            ...
            if($warningAlertStatusFlag === 1){
                ...
                $status = $alertStatus[1];
                $statusMessage = $alertStatusMessage[1];
                InsertAlertCronData($conn,$a_date,$a_time,$companyCode,$deviceId,$sensorId,$sensorTag,$alertTypes,$val,$wariningMessage,$severity,$status,$statusMessage,$alarmType,$current_time,$sensorStatus,$notificationStatus,$hooterRelayStatus);
            }
    }
...
function InsertAlertCronData($conn,$a_date,$a_time,$companyCode,$deviceId,$sensorId,$sensorTag,$alertTypes,$val,$Message,$severity,$status,$statusMessage,$alarmType,$current_time,$sensorStatus,$notificationStatus,$hooterRelayStatus){
